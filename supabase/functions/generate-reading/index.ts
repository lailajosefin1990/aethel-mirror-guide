          ...
          tools: [
            {
              ...
              function: {
                ...
                description: "Deliver the Guidance Journal reading",
                parameters: {
                  type: "object",
                  properties: {
